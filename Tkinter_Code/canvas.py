# A canvas is a widget thet allows you to 'draw' shapes
# Like drawing squares, circles, lines, text etc
# if ou wanted to create paint ou would need a canvas
...
# canvas.create_text((100,200), text= 'this is some text',fill= 'green', width=100)
